  ...
  const experiences = [
    {
      ...
      description: "Architecting scalable web applications using Django REST Framework and microservices, supporting thousands of concurrent users. Improved database performance by 30% through strategic indexing and query optimization. Integrated Stripe payment gateway and third-party APIs, boosting product functionality by 25%.",
      icon: Briefcase,
      skills: ["Django REST", "Microservices", "Stripe Integration", "AJAX", "CI/CD"]
    },
    {
      title: "Python Full Stack Developer Intern",
      company: "Aura HarksCorp",
      location: "Chennai, India",
      period: "January 2024 - March 2024",
      description: "Built and tested web features using Django and modern JavaScript frameworks within Agile sprint cycles. Contributed to API integration, data modeling, and schema design for production-grade client solutions. Collaborated with senior engineers using Git for version control and feature implementation.",
      icon: Code,
      skills: ["Django", "JavaScript", "API Integration", "Git", "Agile"]
    }
  ];
